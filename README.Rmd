...
| :info: This is forked version, which supports an alternative for `pacman::p_load()`, here `pak::pkg_load()`. <br> Please refer to [ventolab/CellphoneDB](https://github.com/r-lib/pak) for the original repository. |
| -------- | 
...
Start with at [_Get Started with pak_](https://pak.r-lib.org/dev/reference/get-started.html) to solve specific issues.
